...
public class FragmentTopFiveExpenses extends Fragment {
    ...
    public static FragmentTopFiveExpenses newInstance() {
        final FragmentTopFiveExpenses fragment = new FragmentTopFiveExpenses();
    ...
    public View onCreateView(final LayoutInflater inflater, final ViewGroup container,
        ...
        final View v = inflater.inflate(R.layout.fragment_top_five_expenses, container,
                false);
        setVariables(v);
        return v;
    }
            ...
            // if the expenses list isn't empty
                ...
                for (final Transaction transaction :
                    ...
                    final LinearLayout childLayout = (LinearLayout) getLayoutInflater()
                            .inflate(R.layout.linearlayout_top_five_expenses, mainLayout, false);
