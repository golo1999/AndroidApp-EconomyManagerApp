...
public class BarChartFragment extends Fragment {
    ...
    public static BarChartFragment newInstance(String param1) {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        ...
                        personalTransactions.forEach((final DataSnapshot transactionsIterator) -> {
                            ...
                            final boolean isCurrentMonthExpense = transaction.getType() == 0 &&
                                    transaction.getTime().getMonth() == currentTime.getMonthValue();
                            ...
                            if ((SELECTED_TYPE.equals("LAST_WEEK_EXPENSES") && !isLastWeekExpense) ||
                                    (SELECTED_TYPE.equals("CURRENT_MONTH_EXPENSES") && !isCurrentMonthExpense) ||
                        ...
                        if (filteredTransactionsList.isEmpty()) {
                            final String noDataText = requireActivity().getResources()
                                    .getString(SELECTED_TYPE.equals("LAST_WEEK_EXPENSES") ?
                                            R.string.no_money_spent_last_week : R.string.no_expenses_made_this_month);
