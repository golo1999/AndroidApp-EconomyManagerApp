...
import com.example.economy_manager.main_part.view.activity.ActivityMainScreen;
...
public class ActivityLogIn extends AppCompatActivity {
                ...
                if (task.isSuccessful()) {
                    if (MyCustomVariables.getFirebaseAuth().getCurrentUser() != null) {
                        if (MyCustomVariables.getFirebaseAuth().getCurrentUser().isEmailVerified()) {
                            ...
                            Toast.makeText(ActivityLogIn.this, getResources().getString(R.string.login_verify_email),
    ...
    private void goToTheMainScreen() {
        Intent intent = new Intent(ActivityLogIn.this, ActivityMainScreen.class);
