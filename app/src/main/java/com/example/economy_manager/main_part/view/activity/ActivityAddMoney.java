        ...
        saveChangesButton.setOnClickListener(v -> {
            ...
            if (selectedID != -1 && MyCustomVariables.getFirebaseAuth().getUid() != null) {
                if (!String.valueOf(valueField.getText()).trim().equals("")) {
                    ...
                    Toast.makeText(ActivityAddMoney.this, R.string.money_error4, Toast.LENGTH_SHORT).show();
                }
            }
            // if there wasn't a radio button checked
            else {
                Toast.makeText(ActivityAddMoney.this, R.string.money_error1, Toast.LENGTH_SHORT).show();
            }
        });
