        ...
        saveChanges.setOnClickListener(v -> {
            ...
            if (selectedID != -1 && MyCustomVariables.getFirebaseAuth().getUid() != null) {
                if (!String.valueOf(value.getText()).trim().equals("")) {
                    ...
                    Toast.makeText(ActivitySubtractMoney.this, R.string.money_error4, Toast.LENGTH_SHORT).show();
                }
            } else {
                Toast.makeText(ActivitySubtractMoney.this, R.string.money_error1, Toast.LENGTH_SHORT).show();
            }
        });
