...
import com.example.economy_manager.main_part.viewmodel.MonthlyBalanceViewModel;
...
public class ActivityMonthlyBalance extends AppCompatActivity {
                            ...
                            if (snapshot.exists() && snapshot.hasChild("PersonalTransactions") &&
                                ...
                                for (final int dayFromDaysList : daysList) {
                                    ...
                                    final String dateTranslated = viewModel
                                            .getDateTranslated(ActivityMonthlyBalance.this, dayFromDaysList);
                                    final LinearLayout dayAndSumLayout =
                                            (LinearLayout) View.inflate(ActivityMonthlyBalance.this,
                                                    R.layout.linearlayout_monthly_balance_title, null);
                                    ...
                                    for (final Transaction transactionsListIterator : transactionsList) {
                                        if (dayFromDaysList == transactionsListIterator.getTime().getDay()) {
                                            if (transactionsListIterator.getCategory() >= 0 &&
                                                    transactionsListIterator.getCategory() < 4) {
                                            ...
                                            typeText.setText(Types
                                                    .getTranslatedType(ActivityMonthlyBalance.this,
    ...
    private void setTitle() {
        ...
        final String month = Months
                .getTranslatedMonth(ActivityMonthlyBalance.this, viewModel.getCurrentMonthName());
